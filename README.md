Проект исследования данных "Netflix Userbase" нацелен на проведение всестороннего анализа пользовательской базы платформы Netflix с целью выявления различных факторов, формирующих прибыль компании.
